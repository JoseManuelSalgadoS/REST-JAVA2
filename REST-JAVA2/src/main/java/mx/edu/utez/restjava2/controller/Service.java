package mx.edu.utez.restjava2.controller;

import mx.edu.utez.restjava2.model.Customer;
import mx.edu.utez.restjava2.model.CustomerDao;
...
public class Service {
    ...
    private Customer getParams(int customerNumber, MultivaluedMap<String, String> formParams){
        ...
        Customer customer = new Customer(customerNumber, customerName, contactLastName, contactFirstName, phone, addressLine1, addressLine2, city,
